...
from LocatorPage.LocatorsPage import (InvalidLoginLocatorsPage, ValidLoginLocatorsPage,
                                      ...
                                      ClickAddNewContact2LocatorsPage,
                                      AddNewContact2LocatorsPage, ClickAddNewContact3LocatorsPage,
                                      AddNewContact3LocatorsPage,
                                      ClickAddNewContact4LocatorsPage, AddNewContact4LocatorsPage,
                                      ClickAddNewContact5LocatorsPage,
                                      AddNewContact5LocatorsPage, ClickAddNewContact6LocatorsPage,
                                      AddNewContact6LocatorsPage,
                                      ClickAddNewContact7LocatorsPage, AddNewContact7LocatorsPage,
                                      ClickAddNewContact8LocatorsPage,
                                      AddNewContact8LocatorsPage, ClickAddNewContact9LocatorsPage,
                                      AddNewContact9LocatorsPage,
                                      ClickAddNewContact10LocatorsPage, AddNewContact10LocatorsPage,
                                      LogoutButtonLocationPage)
...
class AddNewContact2ActionsPage:
    ...
    def fill_contact2_firstname(self, firstname):
        fill_contact2_first_name = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_FIRST_NAME))
    ...
    def fill_contact2_lastname(self, lastname):
        fill_contact2_lastname = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_LAST_NAME))
    ...
    def fill_contact2_birthdate(self, birthdate):
        fill_contact2_birthdate = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_BIRTHDATE))
    ...
    def fill_contact2_email(self, email):
        fill_contact2_email = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_EMAIL))
    ...
    def fill_contact2_phone(self, phone):
        fill_contact2_phone = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_PHONE))
    ...
    def fill_contact2_street1(self, street1):
        fill_contact2_street1 = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_STREET1))
    ...
    def fill_contact2_street2(self, street2):
        fill_contact2_street2 = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_STREET2))
    ...
    def fill_contact2_city(self, city):
        fill_contact2_city = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_CITY))
    ...
    def fill_contact2_state(self, state):
        fill_contact2_state = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_STATE))
    ...
    def fill_contact2_postalcode(self, postalcode):
        fill_contact2_postalcode = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_POSTALCODE))
    ...
    def fill_contact2_country(self, country):
        fill_contact2_country = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_COUNTRY))
    ...
    def fill_contact2_submit(self):
        fill_contact2_submit = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT2_SUBMIT))
...
class AddNewContact3ActionsPage:
    ...
    def fill_contact3_firstname(self, firstname):
        fill_contact3_first_name = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_FIRST_NAME))
    ...
    def fill_contact3_lastname(self, lastname):
        fill_contact3_lastname = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_LAST_NAME))
    ...
    def fill_contact3_birthdate(self, birthdate):
        fill_contact3_birthdate = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_BIRTHDATE))
    ...
    def fill_contact3_email(self, email):
        fill_contact3_email = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_EMAIL))
    ...
    def fill_contact3_phone(self, phone):
        fill_contact3_phone = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_PHONE))
    ...
    def fill_contact3_street1(self, street1):
        fill_contact3_street1 = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_STREET1))
    ...
    def fill_contact3_street2(self, street2):
        fill_contact3_street2 = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_STREET2))
    ...
    def fill_contact3_city(self, city):
        fill_contact3_city = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_CITY))
    ...
    def fill_contact3_state(self, state):
        fill_contact3_state = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_STATE))
    ...
    def fill_contact3_postalcode(self, postalcode):
        fill_contact3_postalcode = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_POSTALCODE))
    ...
    def fill_contact3_country(self, country):
        fill_contact3_country = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_COUNTRY))
    ...
    def fill_contact3_submit(self):
        fill_contact3_submit = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located(AddNewContact1LocatorsPage.FILL_CONTACT3_SUBMIT))
